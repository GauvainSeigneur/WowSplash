...
import com.seigneur.gauvain.wowsplash.ui.home.list.PhotoDataSourceFactoryTwo
import io.reactivex.disposables.CompositeDisposable
import timber.log.Timber

class HomeViewModelTwo(private val mPhotoRepository: PhotoRepository) :
    BaseViewModel() {
    ...
    private val shotDataSourceFactory: PhotoDataSourceFactoryTwo by lazy {
        PhotoDataSourceFactoryTwo(compositeDisposable, mPhotoRepository, null)
    }
